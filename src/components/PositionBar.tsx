...
export default function PositionBar({ stack, history, activeSeatIndex }: Props) {
        ...
        return (
          <div
            ...
            className={`min-w-[84px] flex-1 rounded-lg border px-2 py-2 text-center transition-colors ${
              isActive ? 'border-violet-400 bg-violet-500/15' : entry ? 'border-white/10 bg-white/5' : 'border-white/5 bg-white/[0.02]'
            }`}
          >
