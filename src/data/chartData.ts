// Preflop GTO chart data (100bb 6-max cash reference), adapted from the
// "pekarstas" chart pack in AHTOOOXA/poker-charts (MIT License, Copyright (c) 2025-2026 Anton Safonov)
// https://github.com/AHTOOOXA/poker-charts — positions renamed MP -> HJ to match this app's labels.
// Keys: "{hero}-{scenario}[-{villain}]". Unlisted hands are fold.
import type { Chart } from '../types'

export const rawCharts: Record<string, Chart> = {
  'BB-vs-4bet-BTN': {
